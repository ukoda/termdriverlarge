#ifndef FreeMonoBold_12_h
#define FreeMonoBold_12_h
#include "render_fonts.h"

const uint8_t FreeMono_12Bitmaps[] = {
...
*/
// Offset    w    h  adv     x     y
const GFXglyph FreeMono_12Glyphs[] = {
  {     0,   0,   0,  14,    0,    1 },   // 0x20 ' '
  {     0,   3,  15,  14,    6,  -14 },   // 0x21 '!'
  {     6,   8,   7,  14,    3,  -14 },   // 0x22 '"'
...
const GFXfont FreeMono_12 = {
  (uint8_t  *)FreeMono_12Bitmaps,
  (GFXglyph *)FreeMono_12Glyphs,
  0x20, 0x7E, 24, 15, 5 };
